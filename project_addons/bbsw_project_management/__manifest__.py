# -*- coding: utf-8 -*-
{
    ...
    'website': 'https://blueboltsoftware.com/en',
    'license': 'LGPL-3',
    'images': [],
    ...
    'assets': {
        'web.assets_backend': [
            'bbsw_project_management/static/src/scss/dashboard.scss',
            'bbsw_project_management/static/src/xml/dashboard.xml',
            'bbsw_project_management/static/src/js/dashboard.js',
        ],
    },
    'installable': True,
    'application': True,
