...
class ProjectHomepage(http.Controller):
    ...
    def bb_project_redirect(self, **kw):
        action = (
            request.env.ref('bbsw_project_management.action_bb_project', raise_if_not_found=False)
            or request.env.ref('bb_project_management.action_bb_project', raise_if_not_found=False)
            or request.env.ref('bbsw_project_management.action_bb_project_dashboard', raise_if_not_found=False)
            or request.env.ref('bb_project_management.action_bb_project_dashboard', raise_if_not_found=False)
        )
        menu = (
            request.env.ref('bbsw_project_management.menu_bb_project_all', raise_if_not_found=False)
            or request.env.ref('bb_project_management.menu_bb_project_all', raise_if_not_found=False)
            or request.env.ref('bbsw_project_management.menu_bb_project_root', raise_if_not_found=False)
            or request.env.ref('bb_project_management.menu_bb_project_root', raise_if_not_found=False)
        )
        ...
        menu_root = (
            request.env.ref('bbsw_project_management.menu_bb_project_root', raise_if_not_found=False)
            or request.env.ref('bb_project_management.menu_bb_project_root', raise_if_not_found=False)
        )
        if menu_root:
